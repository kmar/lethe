...
#define LETHE_DEFER(f) struct LETHE_CONCAT_MACROS(core_defer__, __LINE__) { inline ~LETHE_CONCAT_MACROS(core_defer__, __LINE__)(){f();} } LETHE_CONCAT_MACROS(core_defer_, __LINE__)
